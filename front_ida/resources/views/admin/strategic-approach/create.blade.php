...
<div class="container-fluid">
    <h1>Ajouter une approche stratégique</h1>
    <form action="{{ route('admin.strategic-approach.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        ...
        <button type="submit" class="btn btn-primary">Créer l'approche</button>
